...
class AuditModelMixin( models.Model):
    ...
    def save(self,*args, **kwargs, ):
        ...
        #self.user_created = request.user.username
        self.device_created, self.device_modified = update_device_fields(self)
        """ if not change:
            self.user_created = request.user.username
            
        else:
            self.user_modified = request.user.username
            """
        #super().save(request,change,*args, **kwargs)
