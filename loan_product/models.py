...
class loan_product(AuditModelMixin,models.Model):
    ...
    created_by = CurrentUserField(related_name='created_by_loan_product',)
    updated_by = CurrentUserField(on_update=True,related_name='updated_loan_product',)
