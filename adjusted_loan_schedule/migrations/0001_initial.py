    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('principal', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ...
                ('pending_due', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('total_due', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('principal_due', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('created_by', django_currentuser.db.models.fields.CurrentUserField(default=django_currentuser.middleware.get_current_authenticated_user, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='created_by_als', to=settings.AUTH_USER_MODEL)),
                ...
                ('updated_by', django_currentuser.db.models.fields.CurrentUserField(default=django_currentuser.middleware.get_current_authenticated_user, null=True, on_delete=django.db.models.deletion.CASCADE, on_update=True, related_name='updated_by_als', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
